...
main(void)
{
    ...
    ui32TempValueF = ((ui32TempValueC * 9) + 160) / 5;          //fahrenheit

    while(SSIDataGetNonBlocking(SSI0_BASE, &ui32DataRx[0]))
    {
    }
    ...
    //
    ui32DataTx[0] = ui32TempValueF;
    ui32DataTx[1] = ui32TempValueF;
    ui32DataTx[2] = ui32TempValueF;
    ...
    for(ui32Index = 0; ui32Index < NUM_SSI_DATA; ui32Index++)
    {
        ...
        //
        UARTprintf("'%u' ", ui32DataTx[ui32Index]);
    ...
    for(ui32Index = 0; ui32Index < NUM_SSI_DATA; ui32Index++)
    {
        ...
        //
        SSIDataGet(SSI0_BASE, &ui32DataRx[ui32Index]);

        //
        // Since we are using 8-bit data, mask off the MSB.
        //
        ui32DataRx[ui32Index] &= 0x00FF;
